    ...
    public class Cliente
    {
        ...
        public bool Create()
        {
            try
            {
                ...
                Break.Datos.Cliente paa = new Break.Datos.Cliente()
                {
                    RutCliente = this.Rut,
        ...
        public bool Read()
        {
            try
            {
                ...
                Break.Datos.Cliente paa = (from auxpaa in Conexion.Break.Cliente
        ...
        public bool Update()
        {
            try
            {
                ...
                Break.Datos.Cliente paa = Conexion.Break.Cliente.First(p => p.RutCliente == Rut);
